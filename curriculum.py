...
lessons_db = {
    ...
    "M3 W12 D1: Building a Complete Trading Plan": {
        ...
        "questions": [
            {"question": "What is the purpose of a written Trading Plan?", "options": ["To serve as an objective rulebook removing real-time decision fatigue", "To post on social media", "To satisfy regulatory requirements", "To look smart"], "answer": "To serve as an objective rulebook removing real-time decision fatigue"},
            {"question": "What happens if a market setup doesn't fit your plan?", "options": ["You skip it entirely", "You trade it with small size", "You hope for the best", "You add new rules"], "answer": "You skip it entirely"},
            {"question": "What is the most critical element of a trading plan?", "options": ["Rigid risk management rules", "A secret indicator", "High leverage", "Predicting the future"], "answer": "Rigid risk management rules"},
            {"question": "What defines your 'Trading Edge'?", "options": ["A statistical advantage that yields positive expectancy over many trades", "The best computer hardware", "Trading during high volume hours", "A high win rate with 0% risk"], "answer": "A statistical advantage that yields positive expectancy over many trades"},
    ...
    "M4 W13 D1: Advanced Order Types & Iceberg Orders": {
        ...
        "questions": [
            {"question": "What is an Iceberg Order?", "options": ["An order that hides the majority of its size from the public order book", "A frozen crypto wallet", "A tax shelter", "A type of market crash"], "answer": "An order that hides the majority of its size from the public order book"},
            {"question": "What does a Fill-or-Kill (FOK) order mean?", "options": ["Execute immediately in full or cancel entirely", "Fill half and kill the rest", "Hold forever", "Execute only on weekends"], "answer": "Execute immediately in full or cancel entirely"},
            {"question": "Why do institutional block traders use iceberg orders?", "options": ["To prevent moving the market against themselves via slippage", "To pay higher fees", "To hide money from taxes", "To confuse retail bots"], "answer": "To prevent moving the market against themselves via slippage"},
            {"question": "What is a Stop-Limit order?", "options": ["An order that converts to a limit order once a stop price is triggered", "An order with no limits", "A guaranteed fill price", "An exchange shutdown rule"], "answer": "An order that converts to a limit order once a stop price is triggered"},
            {"question": "What is the risk of using a Limit order instead of a Market order?", "options": ["Your order may never get filled if price moves away", "Guaranteed execution", "Higher trading fees", "Immediate slippage"], "answer": "Your order may never get filled if price moves away"}
        ]
    },
    "M4 W14 D1: Volume Profile & Point of Control": {
        "concept": "Analyzing volume traded at specific price levels rather than time.",
        "questions": [
            {"question": "What does Volume Profile display?", "options": ["Volume traded at specific price levels over a given period", "Total volume per day", "Moving average volume", "Tick speed"], "answer": "Volume traded at specific price levels over a given period"},
